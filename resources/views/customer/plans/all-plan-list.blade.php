                ...
                <div class="pricing-plan-content shadow-inner p-4 mb-5 mb-lg-0 heigth-100 position-relative">
                   <div class="pricing-title text-center pb-1">
                       ...
                       @elseif(empty($upgrade_plan->price))
                        <h4 class="my-3 fw-bold">{{$upgrade_plan->billing_style}} </h4>
                       @else
                       <h4 class="my-3 fw-bold"> ${{$upgrade_plan->price}}/<span class="fs-12 fw-normal"> {{$upgrade_plan->billing_style}}  <del class="badge bg-danger fw-normal"> $199/mo </del> </span> </h4>
                      @endif
                   </div>
                   <div class="plan-button text-center">
                       ...
                       <button class="btn app-btn-primary w-100"> Choose plan </button>
                   </div>
                   ...
                   <div class="sticker-wrapper">
                      <div class="sticker text-uppercase fw-bold text-center">{{$upgrade_plan->discount}}</div>
                   </div>
                   @endif
                </div>
              </div>
