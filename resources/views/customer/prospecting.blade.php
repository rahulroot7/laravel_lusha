     ...
     <div class="row">
        <div class="col-md-2 shadow">
          ...
          <div class="col-md-9 mx-auto">
                ...
                <div class="row py-4 border-bottom ">
                    <div class="col-md-6">
                       <div class="prospecting-header">
                          <ul class="list-unstyled p-0 list-cstm d-flex m-0">
            ...
            <div class="row my-5">
                <div class="col-md-4">
                    <div class="wrapper prospecting-accordions bg-white rounded shadow-2">
...
<div class="col-md-8">
         <div class="hide_old_table_example">
           ...
           <div class="suggestion-banner-container">
                 ...
                 <div class="main-content-container">
                    ...
                    <div class="filters-suggestion-wrapper d-lg-flex">
                       <div class="suggestion-button-container border-btn-primary">
                          <small>Department:&nbsp;</smallsmallsmallsmallsmall>
                          <smallsmallsmallsmallsmallsmallsmall>General Management</smallsmallsmallsmallsmallsmall>
                       </div>
                       <div class="suggestion-button-container border-btn-primary">
                          <small>Employees:&nbsp;</smallsmallsmallsmall>
                          <smallsmall>1 - 10</smallsmallsmall>
                       </div>
                    </div>
        ...
        <div class="prespeting_responce"></div>
      <?php $list_name = ''; ?>
